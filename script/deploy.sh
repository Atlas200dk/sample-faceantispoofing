...
function check_faceantispoofing_proto_version()
{
    ...
    cp -f $proto_dir/presenter_message.pb.cc $app_path/face_antispoofing_postprocess/
...
function main()
{
    ...
    echo "Check faceantispoofing proto"
    check_faceantispoofing_proto_version
    if [ $? -ne 0 ];then
        echo "ERROR: check faceantispoofing proto failed"
        return 1
    fi
