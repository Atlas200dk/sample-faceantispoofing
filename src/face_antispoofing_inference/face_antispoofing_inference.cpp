...
*/
HIAI_StatusT face_antispoofing_inference::Init(const hiai::AIConfig &config,
...
bool face_antispoofing_inference::InitAiModel(const AIConfig &config) {
...
bool face_antispoofing_inference::Crop(const shared_ptr<FaceRecognitionInfo> &face_recognition_info, const ImageData<u_int8_t> &org_img,
...
bool face_antispoofing_inference::Resize(const vector<FaceImage> &face_imgs,
...
bool face_antispoofing_inference::ImageYUV2BGR (
...
bool face_antispoofing_inference::Inference(vector<Mat> &normalized_image,
                                       vector<FaceImage> &face_imgs) {
...
void face_antispoofing_inference::EnrichDataByLastMat(vector<Mat> &normalized_image,
    int number) {
...
int face_antispoofing_inference::CopyDataToBuffer(vector<Mat> &normalized_image,
...
bool face_antispoofing_inference::IsDataHandleWrong(shared_ptr<FaceRecognitionInfo> &face_detail_info) {
...
HIAI_StatusT face_antispoofing_inference::SendFailed(const string error_log,
...
HIAI_StatusT face_antispoofing_inference::SendSuccess(
  shared_ptr<FaceRecognitionInfo> &face_recognition_info) {
...
HIAI_IMPL_ENGINE_PROCESS("face_antispoofing_inference", face_antispoofing_inference, INPUT_SIZE)
{
