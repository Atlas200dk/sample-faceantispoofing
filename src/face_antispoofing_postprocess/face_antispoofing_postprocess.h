...
* @date 2018-5-19
*/
#ifndef face_antispoofing_postprocess_ENGINE_H_
#define face_antispoofing_postprocess_ENGINE_H_
...
class face_antispoofing_postprocess : public hiai::Engine {
public:
    face_antispoofing_postprocess();
    ~face_antispoofing_postprocess() = default;
